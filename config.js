...
module.exports = {
    ...
    S_DOWN: process.env.SONGD === undefined ? Lang.DOWNLOADING_SONG, : process.env.SONGD,
    S_UP: process.env.SONGU === undefined ? Lang.UPLOADING_SONG : process.env.SONGU,
    V_DOWN: process.env.VIDEOD === undefined ? Lang.DOWNLOADING_VIDEO : process.env.VIDEOD,
    V_UP: process.env.VIDEOU === undefined ? Lang.UPLOADING_VIDEO : process.env.VIDEOU,
